...
Rename to meaningful measurement variable names by calling User-Defined Function rename.header.
...
Rename to descriptive activities name and further categories using factor.
         ...
         merged_df$activity <- factor(merged_df$activity,levels = c(1,2,3,4,5,6),
